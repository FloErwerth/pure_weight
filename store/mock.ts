    ...
    workouts: [
        {
            ...
            exercises: [
                { type: "CLASSIC", timePerSet: "", name: "Klimmzüge unterstützt", weight: "25", sets: "5", pause: "3", reps: "5" },
                { type: "CLASSIC", timePerSet: "", name: "Rudern Seilzug", weight: "50", sets: "4", pause: "2", reps: "8" },
                { type: "CLASSIC", timePerSet: "", name: "Hintere Schulter Seil", weight: "50", sets: "4", pause: "2", reps: "8" },
                { type: "CLASSIC", timePerSet: "", name: "Bizeps Sz", weight: "10", sets: "4", pause: "2", reps: "8" },
            ],
            doneWorkouts: [],
        },
        {
            ...
            exercises: [
                { type: "CLASSIC", timePerSet: "", name: "Bankdrücken", weight: "50", sets: "5", pause: "2", reps: "5" },
                { type: "CLASSIC", timePerSet: "", name: "Butterfly", weight: "50", sets: "4", pause: "2", reps: "8" },
                { type: "CLASSIC", timePerSet: "", name: "Military", weight: "10", sets: "5", pause: "2", reps: "5" },
                { type: "CLASSIC", timePerSet: "", name: "Seitheben", weight: "10", sets: "4", pause: "2", reps: "8" },
                { type: "CLASSIC", timePerSet: "", name: "Trizeps", weight: "27.5", sets: "4", pause: "2", reps: "8" },
            ],
            doneWorkouts: [],
        },
        {
            ...
            exercises: [
                { type: "CLASSIC", timePerSet: "", name: "Bankdrücken", weight: "50", sets: "5", pause: "2", reps: "5" },
                { type: "CLASSIC", timePerSet: "", name: "Butterfly", weight: "50", sets: "5", pause: "2", reps: "2" },
            ],
            doneWorkouts: [
        ...
        },
        {
            ...
            exercises: [{ type: "CLASSIC", timePerSet: "", name: "Bankdrücken", weight: "50", sets: "5", pause: "2", reps: "5" }],
            doneWorkouts: [
                { duration: "12000", date: "2023-10-16", doneExercises: [{ name: "Bankdrücken", sets: [{ reps: "5", weight: "55" }] }] },
                { duration: "12000", date: "2023-11-18", doneExercises: [{ name: "Bankdrücken", sets: [{ reps: "5", weight: "55" }] }] },
                { duration: "12000", date: "2023-11-20", doneExercises: [{ name: "Bankdrücken", sets: [{ reps: "5", weight: "55" }] }] },
