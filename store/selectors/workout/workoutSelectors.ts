...
export const getOverallStats = createSelector([({ settingsState }: AppState) => settingsState, getWorkouts, getWorkoutStats], ({ unitSystem }, workouts, stats) => {
    ...
    const overallStats = Array.from(stats.values()).reduce(
        ...
        },
        {
            totalNumberOfWorkouts: {
                value: 0,
                unit: undefined,
                translationKey: TranslationKeys.PROFILE_NUMBER_OF_WORKOUTS,
            },
            totalDuration: {
                value: 0,
                unit: "h",
                translationKey: TranslationKeys.PROFILE_DURATION_IN_WORKOUTS,
            },
            totalTimes: {
                value: 0,
                unit: undefined,
                translationKey: TranslationKeys.PROFILE_WORKOUT_TIMES,
            },
            totalMovedWeight: {
                value: 0,
                unit: "",
                translationKey: TranslationKeys.PROFILE_MOVED_WEIGHT,
            },
            totalSets: {
                value: 0,
                unit: undefined,
                translationKey: TranslationKeys.PROFILE_SETS,
            },
            totalReps: {
                value: 0,
                unit: undefined,
                translationKey: TranslationKeys.PROFILE_REPS,
            },
    ...
    const { value, unit: durationUnit } = getDurationInSecondsMinutesOrHours(overallStats.totalDuration.value.toString());
