        ...
        <ThemedView style={[styles.innerWrapper, hasNoIcons && styles.noIconWrapper]}>
            ...
            <HStack style={styles.iconWrapper}>
                {Icon1 && !Icon1?.hide && (
                    <Pressable
                        delayLongPress={200}
                        onLongPress={handleLongPressIcon1}
                        disabled={Icon1?.disabled}
                        onPress={handleClickIcon1}>
                ...
                {Icon2 && !Icon2?.hide && (
                    <Pressable
                        delayLongPress={200}
                        onLongPress={handleLongPressIcon2}
                        disabled={Icon2?.disabled}
                        onPress={handleClickIcon2}>
