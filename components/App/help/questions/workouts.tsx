...
export const getWorkoutsQuestions = (
    ...
    const navigateToHistory = () => handleSelectFromAnswer(SECTIONS.WORKOUTS, 6);
    const navigateToCreateExercise = () => handleSelectFromAnswer(SECTIONS.EXERCISES, 0);
    const navigateToWorkout = () => handleSelectFromAnswer(SECTIONS.WORKOUTS, 0);
    const navigateToDelete = () => handleSelectFromAnswer(SECTIONS.MISCELLANEOUS, 0);
    const navigateToTrends = () => handleSelectFromAnswer(SECTIONS.WORKOUTS, 5);
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                ...
                                <InlinePressable handlePress={navigateToHistory}>Historie</InlinePressable> zu markieren. <NewLine />
                                Außerdem kannst Du <InlinePressable handlePress={navigateToCreateExercise}>Übungen erstellen</InlinePressable>
                            ...
                            <ThemedPressable onPress={setupNewWorkout} center padding round>
                                <Text style={styles.createText}>Klicke hier, um sofort ein neues Workout zu erstellen</Text>
                            </ThemedPressable>
                        </ThemedView>
                    </HelpAnswer>
                ) : (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                ...
                                <InlinePressable handlePress={navigateToHistory}>history</InlinePressable>
                                . <NewLine />
                                You can also <InlinePressable handlePress={navigateToCreateExercise}>create exercises</InlinePressable> that you want to do in your workout.
                                <NewLine />
                            ...
                            <ThemedPressable onPress={setupNewWorkout} center padding round>
                                <Text style={styles.createText}>Click here to create a new workout immediately</Text>
                            </ThemedPressable>
                        </ThemedView>
                    </HelpAnswer>
                ),
            ...
            answer:
                language === "de" ? (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                Um ein Workout zu bearbeiten, benötigst Du zuerst ein vorhandenes <InlinePressable handlePress={navigateToWorkout}>Workout</InlinePressable>
                                .
                                <NewLine />
                                Navigiere zu den <InlinePressable handlePress={handleNavigateToWorkouts}>Workouts</InlinePressable> und wische dann das gewünschte Workout nach rechts. <NewLine />
                                Nun wirst Du zur Workout Bearbeitung navigiert und kannst das gewünschte Workout bearbeiten.
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                ) : (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                To edit a workout, you first need an existing <InlinePressable handlePress={navigateToWorkout}>workout</InlinePressable>
                                .
                                <NewLine />
                                Navigate to the <InlinePressable handlePress={handleNavigateToWorkouts}>workouts</InlinePressable> and swipe the desired workout to the right. <NewLine />
            ...
            answer:
                language === "de" ? (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                Um ein Workout zu löschen, navigiere zu den <InlinePressable handlePress={handleNavigateToWorkouts}>Workouts</InlinePressable> und wische das gewünschte Workout nach
                                links. <NewLine />
                                Dieses Workout wird nun gelöscht. Ein gelöschtes Workout kann nicht wiederhergestellt werden, nachdem{" "}
                                <InlinePressable handlePress={navigateToDelete}>das Zeitfenster</InlinePressable> für das Rückgängig machen abgelaufen ist.
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                ) : (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                To delete a workout, navigate to the <InlinePressable handlePress={handleNavigateToWorkouts}>workouts</InlinePressable> and swipe the desired workout to the left.{" "}
                                <NewLine />
                                This workout will now be deleted. A deleted workout cannot be restored after <InlinePressable handlePress={navigateToDelete}>the time window</InlinePressable> for
                                undoing has expired.
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                ...
                                To change the sorting, click on the sorting button below the title of the workout overview. <NewLine />A dialog will now open in which the sorting can be selected.
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                ),
            ...
            answer:
                language === "de" ? (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                Innerhalb der Kachel eines <InlinePressable handlePress={handleNavigateToWorkouts}>erstellten Workouts</InlinePressable> befindet sich eine Anzeige zu deiner
                                Performance im Workout. <NewLine />
                                ...
                                Ein Klick auf die Performance-Anzeige leitet dich zu den <InlinePressable handlePress={navigateToTrends}>Leistungstrend</InlinePressable> des Workouts weiter.{" "}
                                <NewLine />
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                Inside the tile of a <InlinePressable handlePress={handleNavigateToWorkouts}>created workout</InlinePressable> there is a display of your performance of that workout.{" "}
                                <NewLine />
                                This is only displayed if you have already performed the workout at least twice and there is at least one exercise within the workout that you have completed twice.{" "}
                                <NewLine />
                                The display shows how your performance has changed from the last to the current workout. <NewLine />
                                Clicking on the performance display will take you to the <InlinePressable handlePress={navigateToTrends}>performance trend</InlinePressable> of the workout. <NewLine />
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                ),
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                ...
                                Es öffnet sich ein Kalender, in dem die absolvierten Workouts mit deiner Workout-Farbe markiert sind. Die markierten Tage können angeklickt werden. Der aktuell
                                ausgewählte Tag wird komplett mit deiner Farbe ausgefüllt. Ein auswählbarer Tag mit einem kleinen Punkt. <NewLine />
                                Bei Klick auf einen auswählbares Workout wird der Kalender geschlossen und Du wirst zum Monat des ausgewählten Workout geleitet.
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                ) : (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                ...
                                When you click on &quot;Browse history&quot; you can browse the history for a specific month. <NewLine />A calendar opens in which the completed workouts are marked
                                with your workout color. The marked days can be clicked. The currently selected day is completely filled with your color. A selectable day with a small dot. <NewLine />
                                If you click on a selectable workout, the calendar will close and you will be taken to the month of the selected workout.
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                ),
            ...
            answer:
                language === "de" ? (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                Um ein abgeschlossenes Workout zu bearbeiten, navigiere zur Historie und drücke auf das gewünschte Workout. Du wirst nun zur Bearbeitungsansicht weitergeleitet.{" "}
                                <NewLine />
                                Hier siehst du eine Auflistung der absolvierten Sätze pro Übung. <NewLine />
                                Falls deine Übung eine gewichtsbasierte Übung ist Du kannst hier das Gewicht und die Wiederholungszahl ändern. Andernfalls kannst Du die Dauer deiner Übung ändern.{" "}
                                <NewLine />
                                Wenn Du mit der Bearbeitung fertig bist klicke auf das <ThemedMaterialCommunityIcons name="content-save-outline" size={24} ghost /> Symbol oben rechts. Wenn Du die
                                Bearbeitung abbrechen möchtest navigiere auf die vorherige Seite zurück. <NewLine />
                                Es wird nun ein Dialog angezeigt bei dem Du entscheiden möchtest was mit deinen eingebenen Daten passiert. Du kannst die Änderungen speichern oder verwerfen.
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                ) : (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                To edit a completed workout, navigate to the history and press the desired workout. You will now be taken to the editing view. <NewLine />
                                Here you will see a list of the completed sets per exercise. <NewLine />
                                If your exercise is a weight-based exercise, you can change the weight and the number of repetitions here. Otherwise, you can change the duration of your exercise.{" "}
                                <NewLine />
                                When you are finished editing, click on the <ThemedMaterialCommunityIcons name="content-save-outline" size={24} ghost /> symbol in the top right. If you want to cancel
                                the editing, navigate back to the previous page. <NewLine />A dialog will now be displayed asking you what to do with your entered data. You can save or discard the
                                changes.
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
