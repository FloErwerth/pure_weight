                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                ...
                                Außerdem kannst Du <InlinePressable handlePress={() => handleSelectFromAnswer(SECTIONS.EXERCISES, 0)}>Übungen erstellen</InlinePressable>, welche Du in deinem Workout
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                ...
                                You can also <InlinePressable handlePress={() => handleSelectFromAnswer(SECTIONS.EXERCISES, 0)}>create exercises</InlinePressable> that you want to do in your workout.
                                <NewLine />
            ...
            answer:
                language === "de" ? (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                Um ein Workout zu löschen, navigiere zu den <InlinePressable handlePress={handleNavigateToWorkouts}>Workouts</InlinePressable> und wische dann das gewünschte Workout
                                nach links. {"\n\n"}
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                To delete a workout, navigate to the <InlinePressable handlePress={handleNavigateToWorkouts}>Workouts</InlinePressable> and then swipe the desired workout to the left.{" "}
                                {"\n\n"}
            ...
            answer:
                language === "de" ? (
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                Inside the tile of a created <InlinePressable handlePress={handleNavigateToWorkouts}>workout</InlinePressable> there is a display of your performance of a workout.{" "}
                                <NewLine />
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                ...
                                <InlinePressable handlePress={() => handleSelectFromAnswer(SECTIONS.WORKOUTS, 0)}>Workout-Farbe</InlinePressable> markiert sind. Die markierten Tage können angeklickt
                                werden. Der aktuell ausgewählte Tag wird komplett mit deiner Farbe ausgefüllt. Ein auswählbarer Tag mit einem kleinen Punkt. <NewLine />
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                ...
                                with your <InlinePressable handlePress={() => handleSelectFromAnswer(SECTIONS.WORKOUTS, 0)}>workout color</InlinePressable>. The marked days can be clicked. The
                                currently selected day is completely filled with your color. A selectable day with a small dot. <NewLine />
