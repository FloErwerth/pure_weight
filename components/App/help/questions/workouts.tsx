                ...
                language === "de" ? (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                <InlinePressable handlePress={handleNavigateToWorkouts}>Navigiere zu Workouts</InlinePressable>, klicke auf
                                das <ThemedMaterialCommunityIcons name="plus" size={24} ghost />
                                -Symbol. Nun wirst Du zur Workout-Erstellung weitergeleitet. <NewLine />
                                Hier kannst Du nun einen Namen und eine Farbe für dein Workout einstellen. Die Farbe wird dazu verwendet, um
                                das Workout in der Übersicht und in der{" "}
                                <InlinePressable handlePress={() => handleSelectFromAnswer(SECTIONS.WORKOUTS, 6)}>
                                    Historie
                                </InlinePressable>{" "}
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                <InlinePressable handlePress={handleNavigateToWorkouts}>Navigate to the workouts</InlinePressable>, click on
                                the <ThemedMaterialCommunityIcons name="plus" size={24} ghost /> symbol. Now you will be redirected to the
                                workout creation. <NewLine />
                                Here you can set a name and a color for your workout. The color is used to mark the workout in the overview
                                and in the{" "}
                                <InlinePressable handlePress={() => handleSelectFromAnswer(SECTIONS.WORKOUTS, 6)}>
                                    history
                                </InlinePressable>. <NewLine />
                                You can also{" "}
                                <InlinePressable handlePress={() => handleSelectFromAnswer(SECTIONS.EXERCISES, 0)}>
                                    create exercises
                                </InlinePressable>{" "}
                                ...
                                <NewLine />
                                When you are done, click on the <ThemedMaterialCommunityIcons name="check" size={24} ghost /> symbol in the
                                top right corner of the workout creation screen.
                            </AnswerText>
                            <ThemedPressable onPress={setupNewWorkout} center padding round>
            ...
            answer:
                language === "de" ? (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                Erstellte <InlinePressable handlePress={handleNavigateToWorkouts}>Workouts</InlinePressable> können in der
                                Übersicht sortiert werden. <NewLine />
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                Created <InlinePressable handlePress={handleNavigateToWorkouts}>workouts</InlinePressable> can be sorted in
                                the overview. <NewLine />
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                ...
                                <InlinePressable handlePress={() => handleSelectFromAnswer(SECTIONS.WORKOUTS, 5)}>
                                    Leistungstrend
                                </InlinePressable>{" "}
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                ...
                                Es werden die Workout-Daten pro Tag angezeigt. Es können maximal die letzten 100 Übungen eines Workouts
                                angezeigt werden. <NewLine />
                                Der Leistungstrend zeigt standardmäßig das bewegte Gesamtgewicht pro Tag an. Diese Option heißt
                                &quot;Kumulativ&quot;. <NewLine />
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                ...
                                The workout data is displayed per day. A maximum of the last 100 exercises of a workout can be displayed.{" "}
                                <NewLine />
                                The performance trend shows the total weight moved per day by default. This option is called
                                &quot;cumulative&quot;. <NewLine />
            ...
            answer:
                language === "de" ? (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                Wenn Du mindestens ein Workout abgeschlossen hast wird innerhalb der Workout-Kachel ein Indikator für deine
                                Workout-Historie angezeigt. <NewLine />
                                Der Indikator zeigt an wie viele Workouts du abgeschlossen hast und leitet dich bei Klick zur Historie
                                weiter. <NewLine />
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                If you have completed at least one workout, an indicator for your workout history will be displayed within
                                the workout tile. <NewLine />
                                The indicator shows how many workouts you have completed and takes you to the history when clicked.{" "}
                                <NewLine />
