                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                ...
                                Wenn Du damit fertig bist, klicke auf &quot;Bestätigen&quot; am unteren Ende des Dialogs. Der Dialog schließt sich und die bearbeitete Übung wird im Workout hinterlegt.
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                ) : (
                    ...
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                ...
                                Gewichtsbasierte Übungen sind klassische Übungen aus dem Fitnessstudio (z.B. Bankdrücken). Werte können sein: Gewicht, Sätze, Wiederholungen und optional eine Pause.
                                <NewLine />
                                Zeitbasierte Übungen können viele Formen annehmen (z.B. Laufen oder Radfahren). Zeitbasierte Übungen können folgende Werte annehmen: Sätze, eine Vorbereitungszeit, die
                                Dauer und die Pause. <NewLine />
                                Die Vorbereitungszeit ist die Zeit, welche vor dem eigentlichen Start der Übung benötigt wird, um sich auf die Übung vorzubereiten (z.B. das Hinlegen bei Planks).
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                ) : (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={{ gap: 20 }}>
                            <AnswerText>
                                ...
                                Weight-based exercises are classic exercises from the gym (e.g. bench press). Values can be: weight, sets, repetitions and optionally a break. <NewLine />
                                Time-based exercises can take many forms (e.g. running or cycling). Time-based exercises can take the following values: sets, a preparation time, the duration and the
                                break. <NewLine />
                                The preparation time is the time needed before the actual start of the exercise to prepare for the exercise (e.g. lying down for planks).
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                ),
