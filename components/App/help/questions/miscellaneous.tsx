...
export const getMiscellaneousQuestions = (navigateToSettings: (sectionIndex: number) => void, language: Language): QuestionAnswerArray => {
    const showGeneralSettings = () => navigateToSettings(0);
    return [
        {
                ...
                language === "de" ? (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                Nachdem Du etwas gelöscht hast, erscheint am unteren Bildschirmrand ein Hinweis, dass etwas gelöscht wurde. Klicke auf den Hinweis, um die Löschung rückgängig zu
                                machen. Dieser Hinweis wird nach einiger Zeit automatisch verschwinden.
                                ...
                                <InlinePressable handlePress={showGeneralSettings}>allgemeinen Einstellungen</InlinePressable> unter &quot;Löschzeit&quot; geändert werden.
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                ) : (
                    <HelpAnswer>
                        <ThemedView ghost stretch style={styles.bigGap}>
                            <AnswerText>
                                ...
                                <InlinePressable handlePress={showGeneralSettings}>general settings</InlinePressable> under &quot;Deletion time&quot;.
                            </AnswerText>
                        </ThemedView>
                    </HelpAnswer>
                ),
