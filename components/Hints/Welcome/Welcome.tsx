            ...
            {isFirstTimeRendered && (
                <ThemedBottomSheetModal ref={ref}>
                    <VStack style={{ gap: 15 }}>
                        ...
                        <HStack
                            style={{ backgroundColor: componentBackgroundColor, borderRadius, padding: 10, alignItems: "center", gap: 5 }}>
                            <MaterialCommunityIcons name="weight" color={mainColor} size={20} />
                            <Text style={{ paddingRight: 15, fontSize: 16, paddingLeft: 10, color: mainColor }}>
                                This app is designed to track weights as simple as possible
                            </Text>
                        </HStack>
                        <HStack
                            style={{ backgroundColor: componentBackgroundColor, borderRadius, padding: 10, alignItems: "center", gap: 5 }}>
                            ...
                            <Text style={{ paddingRight: 15, fontSize: 16, paddingLeft: 10, color: mainColor }}>
                                Your data is stored only on your phone and will not be send to any server
                            </Text>
                        </HStack>
                        <HStack
                            style={{ backgroundColor: componentBackgroundColor, borderRadius, padding: 10, alignItems: "center", gap: 5 }}>
                            ...
                            <Text style={{ paddingRight: 15, fontSize: 16, paddingLeft: 10, color: mainColor }}>
                                Feel free to contact me to give feedback to features or witnessing a bug
                            </Text>
                        </HStack>
                        <View>
                            <Text style={{ fontSize: 16, textAlign: "center", color: mainColor }}>
                                To create your first workout press the <MaterialCommunityIcons name="plus" color={mainColor} size={20} /> on
