        ...
        <>
            {isFirstTimeRendered && (
                <ThemedBottomSheetModal ref={ref}>
                    <VStack style={{ gap: 15 }}>
                        <Text style={{ fontSize: 26, textAlign: "center", color: mainColor }}>
                            Welcome to Pure Weight
                        </Text>
                        <HStack
                            style={{
                        ...
                        <View>
                            <Text style={{ fontSize: 16, textAlign: "center", color: mainColor }}>
                                To create your first workout press the{" "}
                                <MaterialCommunityIcons name="plus" color={mainColor} size={20} /> on the top right of
                                the screen
                            </Text>
                        </View>
